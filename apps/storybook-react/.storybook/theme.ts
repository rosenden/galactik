...
const brandMeta = {
  brandTitle: 'Galactik REACT UI',
  brandUrl: '/?path=/story/home--default',
  brandTarget: '_self'
};

export const galactikReactLightTheme = create({
  base: 'light',
  ...brandMeta,
...
export const galactikReactDarkTheme = create({
  base: 'dark',
  ...brandMeta,
...
export default galactikReactLightTheme;
