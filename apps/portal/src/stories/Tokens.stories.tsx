  ...
  render: () => (
    ...
    >
      ...
      <p style={{ color: 'var(--color-font-neutral-muted)' }}>
        Visualizing every variable exposed by <code>tokens.css</code>.
      </p>

      <Section title="Palette">
        {colorFamilies.map(renderColorFamily)}
        <h3 style={{ margin: '20px 0 8px', fontSize: 16 }}>Colors extracted from Figma</h3>
        <Grid cols={6}>
          {[
            '--colors-figma-color',
        ...
        <h3 style={{ margin: '20px 0 8px', fontSize: 16 }}>Absolute / neutral palette</h3>
        <Grid cols={6}>
      ...
      <Section title="Typography">
        <div style={{ marginBottom: 8, color: '#6b7280', fontSize: 12 }}>
          Family: <code>var(--font-family-base)</code> – Weight: <code>regular / semibold / bold</code>
        </div>
