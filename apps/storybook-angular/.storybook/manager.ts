...
import galactikAngularLightTheme, { galactikAngularDarkTheme } from './theme';

const applyTheme = (mode?: string) => {
  addons.setConfig({
    theme: mode === 'dark' ? galactikAngularDarkTheme : galactikAngularLightTheme,
    sidebar: { 
      showRoots: true,
      collapsedRoots: []
    },
...
addons.register('galactik/theme-switcher', (api) => {
  ...
  // Set default story to Home so sidebar/logo land there
