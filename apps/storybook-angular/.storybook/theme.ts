...
const brandMeta = {
  brandTitle: 'Galactik ANGULAR UI',
  brandUrl: '/?path=/story/home--default',
  brandTarget: '_self'
};

export const galactikAngularLightTheme = create({
  base: 'light',
  ...brandMeta,
...
export const galactikAngularDarkTheme = create({
  base: 'dark',
  ...brandMeta,
...
export default galactikAngularLightTheme;
