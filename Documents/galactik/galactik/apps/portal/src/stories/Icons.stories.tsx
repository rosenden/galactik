  ...
  return (
    ...
    >
      <header style={{ marginBottom: 'var(--space-3xl)' }}>
        <h1 style={{ margin: 0, fontSize: 'var(--font-size-4xl)' }}>Bibliothèque d’icônes (Font Awesome Regular)</h1>
        <p style={{ marginTop: 'var(--space-sm)', color: 'var(--color-font-neutral-base)' }}>
          Ensemble des icônes Classic Regular disponibles via Font Awesome Pro. Utilisez la barre de recherche pour
          filtrer par nom.
        </p>
      </header>
      ...
      >
        ...
        <input
          id="icon-search"
          type="text"
          placeholder="Ex : user, arrow, calendar…"
          value={query}
      ...
      <div style={{ maxHeight: '75vh', overflow: 'auto', borderRadius: 20, border: `1px solid var(--color-border-base)` }}>
        <table style={tableStyle}>
          <thead>
            <tr>
              <th style={headerCellStyle}>Aperçu</th>
