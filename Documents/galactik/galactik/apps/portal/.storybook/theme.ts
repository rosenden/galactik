...
const logo: string = require('./assets/logo-chapsvision.svg');
...
const brandMeta = {
  brandTitle: 'Galactik – Portal',
  brandUrl: 'https://galactik.design',
  brandTarget: '_self',
  brandImage: logo
};

export const galactikPortalLightTheme = create({
  base: 'light',
  ...brandMeta,
...
export const galactikPortalDarkTheme = create({
  base: 'dark',
  ...brandMeta,
...
export default galactikPortalLightTheme;
