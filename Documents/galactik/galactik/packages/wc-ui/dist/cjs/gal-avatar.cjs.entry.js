...
const GalAvatar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: classes, role: "img", "aria-label": this.getAlt() }, index.h("div", { class: "qa-avatar__clip" }, this.src ? (index.h("img", { class: "qa-avatar__img", src: this.src, alt: this.getAlt() })) : (index.h("span", { "aria-hidden": "true" }, this.getInitials()))), this.status !== 'none' && (index.h("span", { class: ['qa-avatar__status', `qa-status--${this.status}`].join(' '), "aria-hidden": "true" })))));
  }
};
