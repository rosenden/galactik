...
const GalBullet = class {
  ...
  render() {
    ...
    if (this.size === 'xsmall') {
      ...
      return (index.h(index.Host, null, index.h("span", { class: `oc-bullet oc-bullet--${this.size} oc-bullet--${this.variant} oc-bullet--${this.color}`, style: bulletStyle, role: "presentation", "aria-hidden": "true" })));
    }
    ...
    return (index.h(index.Host, null, index.h("span", { class: `oc-bullet oc-bullet--${this.size} oc-bullet--${this.variant} oc-bullet--${this.color}`, style: outerStyle, role: "presentation", "aria-hidden": "true" }, index.h("span", { style: innerStyle }))));
  }
};
GalBullet.style = galBulletCss;

exports.gal_bullet = GalBullet;

//# sourceMappingURL=gal-bullet.cjs.entry.js.map