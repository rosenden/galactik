...
const GalBadge$1 = /*@__PURE__*/ proxyCustomElement(class GalBadge extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return galBadgeCss; }
}, [1, "gal-badge", {
    "number": [2],
    "size": [1],
    "color": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["gal-badge"];
  components.forEach(tagName => { switch (tagName) {
    case "gal-badge":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GalBadge$1);
      }
      break;
  } });
}

const GalBadge = GalBadge$1;
const defineCustomElement = defineCustomElement$1;

export { GalBadge, defineCustomElement };
