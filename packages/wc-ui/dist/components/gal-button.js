...
const GalButton$1 = /*@__PURE__*/ proxyCustomElement(class GalButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get el() { return this; }
  static get style() { return galButtonCss; }
}, [1, "gal-button", {
    "variant": [1],
    "colorVariant": [1, "color-variant"],
    "size": [1],
    "disabled": [4],
    "loading": [4],
...
function defineCustomElement$1() {
  ...
  const components = ["gal-button"];
  components.forEach(tagName => { switch (tagName) {
    case "gal-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GalButton$1);
      }
      break;
  } });
}

const GalButton = GalButton$1;
const defineCustomElement = defineCustomElement$1;

export { GalButton, defineCustomElement };
