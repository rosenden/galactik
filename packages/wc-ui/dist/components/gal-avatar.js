...
const GalAvatar$1 = /*@__PURE__*/ proxyCustomElement(class GalAvatar extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return galAvatarCss; }
}, [1, "gal-avatar", {
    "name": [1],
    "src": [1],
    "icon": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["gal-avatar"];
  components.forEach(tagName => { switch (tagName) {
    case "gal-avatar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GalAvatar$1);
      }
      break;
  } });
}

const GalAvatar = GalAvatar$1;
const defineCustomElement = defineCustomElement$1;

export { GalAvatar, defineCustomElement };
